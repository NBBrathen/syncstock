...
def filter_order(
    ...
    return crud.filter_orders(db, status=status, customer_email=customer_email, skip=skip, limit=limit)
...
def update_order_status(
    ...
    updated_order = crud.update_order_status(db, order_id=order_id, status=status_update.status.value)
